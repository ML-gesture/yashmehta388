...
mouse = Controller()
face_cascade = cv2.CascadeClassifier('C:/Python/Python36/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')
eye_cascade = cv2.CascadeClassifier('C:/Python/Python36/Lib/site-packages/cv2/data/haarcascade_eye.xml')
#m = PyMouse()
